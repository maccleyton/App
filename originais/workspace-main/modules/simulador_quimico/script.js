...
// Moléculas Prontas do Arquivo Original
const molecules = {
    h2o: {
        name: "Água", formula: "H₂O", mass: "18.02 g/mol", geometry: "Angular", type: "Inorgânica",
        atoms: [
    ...
    co2: {
        name: "Dióxido de Carbono", formula: "CO₂", mass: "44.01 g/mol", geometry: "Linear", type: "Inorgânica",
        atoms: [
    ...
    ch4: {
        name: "Metano", formula: "CH₄", mass: "16.04 g/mol", geometry: "Tetraédrica", type: "Orgânica",
        atoms: [
            { element: "C", x: 0, y: 0, z: 0 },
    ...
    c2h5oh: {
        name: "Etanol", formula: "C₂H₅OH", mass: "46.07 g/mol", geometry: "Complexa", type: "Orgânica",
        atoms: [
            { element: "C", x: 0, y: 0, z: 0 }, { element: "C", x: 1.54, y: 0, z: 0 },
            { element: "O", x: 2.1, y: 1.0, z: 0 }, { element: "H", x: -0.51, y: 0.89, z: 0 },
            { element: "H", x: -0.51, y: -0.89, z: 0 }, { element: "H", x: 0.51, y: 0, z: 0.89 },
            { element: "H", x: 2.05, y: -0.89, z: 0 }, { element: "H", x: 2.05, y: 0, z: -0.89 },
            { element: "H", x: 2.65, y: 1.0, z: 0 }
        ],
        bonds: [{ from: 0, to: 1, type: "single" }, { from: 1, to: 2, type: "single" }, { from: 0, to: 3, type: "single" }, { from: 0, to: 4, type: "single" }, { from: 0, to: 5, type: "single" }, { from: 1, to: 6, type: "single" }, { from: 1, to: 7, type: "single" }, { from: 2, to: 8, type: "single" }]
    },
    c6h6: {
        name: "Benzeno", formula: "C₆H₆", mass: "78.11 g/mol", geometry: "Hexagonal", type: "Orgânica",
        atoms: [
            { element: "C", x: 1, y: 0, z: 0 }, { element: "C", x: 0.5, y: 0.866, z: 0 },
            { element: "C", x: -0.5, y: 0.866, z: 0 }, { element: "C", x: -1, y: 0, z: 0 },
            { element: "C", x: -0.5, y: -0.866, z: 0 }, { element: "C", x: 0.5, y: -0.866, z: 0 },
            { element: "H", x: 2, y: 0, z: 0 }, { element: "H", x: 1, y: 1.732, z: 0 },
            { element: "H", x: -1, y: 1.732, z: 0 }, { element: "H", x: -2, y: 0, z: 0 },
            { element: "H", x: -1, y: -1.732, z: 0 }, { element: "H", x: 1, y: -1.732, z: 0 }
        ],
        bonds: [{ from: 0, to: 1, type: "double" }, { from: 1, to: 2, type: "single" }, { from: 2, to: 3, type: "double" }, { from: 3, to: 4, type: "single" }, { from: 4, to: 5, type: "double" }, { from: 5, to: 0, type: "single" }]
    },
    c6h12o6: {
        name: "Glicose", formula: "C₆H₁₂O₆", mass: "180.16 g/mol", geometry: "Complexa", type: "Orgânica",
        atoms: [
            { element: "C", x: 0, y: 1, z: 0 }, { element: "C", x: 1, y: 0.5, z: 0 }, { element: "C", x: 1, y: -0.5, z: 0 },
            { element: "C", x: 0, y: -1, z: 0 }, { element: "C", x: -1, y: -0.5, z: 0 }, { element: "C", x: -1, y: 0.5, z: 0 },
            { element: "O", x: 0, y: 2, z: 0 }, { element: "O", x: 2, y: 1, z: 0 }, { element: "O", x: 2, y: -1, z: 0 },
            { element: "O", x: 0, y: -2, z: 0 }
        ],
        bonds: [{ from: 0, to: 1, type: "single" }, { from: 1, to: 2, type: "single" }, { from: 2, to: 3, type: "single" }, { from: 3, to: 4, type: "single" }, { from: 4, to: 5, type: "single" }, { from: 5, to: 0, type: "single" }]
    },
    c3h6o: {
        name: "Acetona", formula: "C₃H₆O", mass: "58.08 g/mol", geometry: "Trigonal", type: "Orgânica",
        atoms: [
            { element: "C", x: 0, y: 0, z: 0 }, { element: "C", x: 1.5, y: 0, z: 0 },
            { element: "C", x: -1.5, y: 0, z: 0 }, { element: "O", x: 0, y: 1.2, z: 0 }
        ],
        bonds: [{ from: 0, to: 1, type: "single" }, { from: 0, to: 2, type: "single" }, { from: 0, to: 3, type: "double" }]
    },
    c2h4: {
        name: "Eteno", formula: "C₂H₄", mass: "28.05 g/mol", geometry: "Trigonal", type: "Orgânica",
        atoms: [{ element: "C", x: 0, y: 0, z: 0 }, { element: "C", x: 1.33, y: 0, z: 0 }],
        bonds: [{ from: 0, to: 1, type: "double" }]
    },
    c2h2: {
        name: "Etino", formula: "C₂H₂", mass: "26.04 g/mol", geometry: "Linear", type: "Orgânica",
        atoms: [{ element: "C", x: 0, y: 0, z: 0 }, { element: "C", x: 1.2, y: 0, z: 0 }],
        bonds: [{ from: 0, to: 1, type: "triple" }]
    },
    nh3: {
        name: "Amônia", formula: "NH₃", mass: "17.03 g/mol", geometry: "Piramidal", type: "Inorgânica",
        atoms: [
            { element: "N", x: 0, y: 0, z: 0 }, { element: "H", x: 0.63, y: 0.63, z: 0.45 },
            { element: "H", x: -0.63, y: 0.63, z: -0.45 }, { element: "H", x: 0, y: -0.89, z: 0 }
        ],
        bonds: [{ from: 0, to: 1, type: "single" }, { from: 0, to: 2, type: "single" }, { from: 0, to: 3, type: "single" }]
    }
};

// Função para carregar moléculas prontas
function loadMolecule(moleculeKey) {
    ...
    molecule.atoms.forEach((atom, index) => {
        ...
        const atomGroup = createAtomGroup(
            elements.find(el => el.symbol === atom.element)
        );
    ...
    molecule.bonds.forEach(bond => {
        ...
        const radius = bond.type === 'single' ? 0.1 : (bond.type === 'double' ? 0.15 : 0.2);
        const bondGeometry = new THREE.CylinderGeometry(radius, radius, distance, 8);
...
function showMoleculeInfo(molecule) {
    ...
    infoPanel.innerHTML = `
        <div style="padding: 20px;">
            <div style="font-size: 2em; font-weight: 700; margin-bottom: 10px; color: var(--text-primary);">${molecule.formula}</div>
            <div style="font-size: 1.1em; margin-bottom: 5px; color: var(--text-secondary);">${molecule.name}</div>
            <div style="display: inline-block; padding: 4px 12px; background: ${categoryColors[molecule.type] || 'var(--accent-soft)'}; color: var(--workspace-bg); border-radius: 4px; font-size: 0.85em; margin-bottom: 15px;">${molecule.type}</div>
            
            <div class="property-row">
                <div class="property-label">Massa Molar</div>
                <div class="property-value">${molecule.mass}</div>
            </div>
            <div class="property-row">
                <div class="property-label">Geometria</div>
                <div class="property-value">${molecule.geometry}</div>
            </div>
        </div>
    `;
}

// Event Listeners para os botões de molécula
document.addEventListener('DOMContentLoaded', function() {
    // ... código existente ...
    
    // Eventos das moléculas prontas
    document.addEventListener('click', (e) => {
        if (e.target.classList.contains('viewer-btn') && e.target.dataset.molecule) {
            loadMolecule(e.target.dataset.molecule);
        }
    });
    
    // Botão do construtor
    document.getElementById('builderModeBtn').addEventListener('click', toggleBuilderMode);
    
    // Botões do painel de molécula
    document.getElementById('clearMoleculeBtn').addEventListener('click', () => {
        selectedElementsForMolecule = [];
        updateMoleculePanel();
        clearMolecule();
    });
    
    document.getElementById('saveMoleculeBtn').addEventListener('click', () => {
        if (selectedElementsForMolecule.length > 0) {
            const formula = selectedElementsForMolecule.map(el => el.symbol).join('');
            const moleculeName = prompt('Nome da molécula:', formula);
            if (moleculeName) {
                alert(`Molécula ${moleculeName} salva com sucesso!`);
            }
        }
    });
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Event listener para o botão do construtor (agora fixo)
    const builderBtn = document.getElementById('builderModeBtn');
    if (builderBtn) {
        builderBtn.addEventListener('click', toggleBuilderMode);
    }	
});
...
function createClassFilterButtons() {
    ...
    filterContainer.className = 'class-filters';
    filterContainer.innerHTML = `
        <button data-class="todos" class="filter-btn active">Todos</button>
        <button data-class="metais-alcalinos" class="filter-btn">Metais Alcalinos</button>
        <button data-class="metais-alcalinoterrosos" class="filter-btn">Alcalinoterrosos</button>
        <button data-class="metais-transicao" class="filter-btn">Metais Transição</button>
        <button data-class="semimetais" class="filter-btn">Semimetais</button>
        <button data-class="nao-metais" class="filter-btn">Não-Metais</button>
        <button data-class="halogenios" class="filter-btn">Halogênios</button>
        <button data-class="gases-nobres" class="filter-btn">Gases Nobres</button>
        <button data-class="metais-basicos" class="filter-btn">Metais Básicos</button>
    `;
    
    const sidebar = document.querySelector('.sidebar-content');
    sidebar.insertBefore(filterContainer, document.getElementById('periodicTableGrid'));
    
    filterContainer.addEventListener('click', (e) => {
        if (e.target.classList.contains('filter-btn')) {
            document.querySelectorAll('.filter-btn').forEach(btn => btn.classList.remove('active'));
            e.target.classList.add('active');
            filterByClass(e.target.dataset.class);
        }
    });
}
...
function filterByClass(className) {
    ...
    cards.forEach(card => {
        const element = elements.find(el => el.symbol === card.dataset.symbol);
        if (!element) return;
        
        if (className === 'todos' || 
            chemicalClasses[className]?.includes(element.category)) {
...
function enterBuilderMode() {
    ...
    document.querySelectorAll('.element-card').forEach(card => {
        card.addEventListener('click', addToMoleculeBuilder);
        card.style.cursor = 'copy';
        card.title = 'Clique para adicionar à molécula';
    });
    
    document.getElementById('moleculePanel').style.display = 'block';
    document.getElementById('moleculeFormula').textContent = 'Selecione elementos';
}

function exitBuilderMode() {
    document.querySelectorAll('.element-card').forEach(card => {
        card.removeEventListener('click', addToMoleculeBuilder);
        card.style.cursor = 'pointer';
        card.title = '';
    });
    
    document.getElementById('moleculePanel').style.display = 'none';
    
    if (currentElement) {
        update3DViewer(currentElement);
    }
}

function addToMoleculeBuilder(event) {
    const elementSymbol = event.currentTarget.dataset.symbol;
    const element = elements.find(el => el.symbol === elementSymbol);
    
    if (element && selectedElementsForMolecule.length < 6) {
...
function renderMoleculeBuilder() {
    clearMolecule();
    
    if (selectedElementsForMolecule.length === 0) return;
    
    const group = new THREE.Group();
    const radius = 3;
    
    selectedElementsForMolecule.forEach((element, index) => {
        const phi = Math.acos(-1 + (2 * index) / selectedElementsForMolecule.length);
        const theta = Math.sqrt(selectedElementsForMolecule.length * Math.PI) * phi;
...
function createMolecularBonds() {
    if (selectedElementsForMolecule.length < 2) return;
    
    // Criar ligações simples entre elementos adjacentes
    for (let i = 0; i < selectedElementsForMolecule.length - 1; i++) {
        const start = getAtomPosition(i);
        const end = getAtomPosition(i + 1);
...
function getAtomPosition(index) {
    const radius = 3;
    const phi = Math.acos(-1 + (2 * index) / selectedElementsForMolecule.length);
    const theta = Math.sqrt(selectedElementsForMolecule.length * Math.PI) * phi;
...
function updateMoleculePanel() {
    const formula = selectedElementsForMolecule.map(el => el.symbol).join('');
    document.getElementById('moleculeFormula').textContent = formula || 'Selecione elementos';
    
    const elementsList = document.getElementById('moleculeElements');
    elementsList.innerHTML = selectedElementsForMolecule.map(el => 
        `<span class="molecule-element-tag">${el.symbol}</span>`
    ).join('');
}

function clearMolecule() {
    // Remover átomos e ligações
    const objectsToRemove = [];
    scene.traverse(child => {
        if (child.isMesh && child.userData.isAtom) {
    ...
    // Remover ligações
    moleculeBonds.forEach(bond => scene.remove(bond));
    moleculeBonds = [];
}
